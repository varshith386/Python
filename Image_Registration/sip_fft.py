...
output_aligned_directory1 = r'C:\Users\hp\OneDrive\Desktop\out7'
...
def print_evaluation_metrics3(overlap_measure, jaccard_index, euclidean_distance, mse_value):
    print("-----FFT-----")
...
def plot_images3(fixed_image, aligned_images, mean_aligned_image, weight):
...
print_evaluation_metrics3(o_measure, J_measure, euclidean_distance, mse_value)
plot_images3(fixed_image, aligned_images[1], mean_aligned_image, central_weights[2])